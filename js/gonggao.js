...
$.ajax({
    ...
    data: {
        key: 'QSRBZ-WEL6F-3SKJ4-JHHVL-5KMVT-3MFON',
        output: 'jsonp',
    },
    dataType: 'jsonp',
    success: function (res) {
        ...
        function showWelcome() {
            ...
            let dist = getDistance(114.27, 22.73, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
